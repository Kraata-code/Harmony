...
import com.kraata.harmony.constants.MediaSessionConstants
...
class MediaLibrarySessionCallback @Inject constructor(
    ...
    private fun com.kraata.harmony.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
